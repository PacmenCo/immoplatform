        ...
        {canPickFreelancer && (
          <div className="w-full sm:w-[200px] sm:shrink-0">
            <SearchSelect
              ...
              placeholder={t("allFreelancers")}
              searchPlaceholder={t("freelancerSearchPlaceholder")}
              clearOptionLabel={t("allFreelancers")}
              options={[
                { value: "none", label: t("freelancerUnassigned") },
                ...freelancers.map((f) => ({
                  value: f.id,
