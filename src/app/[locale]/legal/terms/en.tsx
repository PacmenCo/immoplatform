...
// Per-locale source document for the EN terms of service. Translators / legal
// counsel edit each locale's source file as a complete document — see
// `nl-BE.tsx` for the Flemish counterpart. The shared loader (`page.tsx`)
// dispatches based on the active route locale and supplies Nav/Footer chrome.
...
export default function TermsEnContent() {
  return (
    <>
