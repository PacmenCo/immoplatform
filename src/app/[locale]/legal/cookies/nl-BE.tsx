// nl-BE COOKIE POLICY — TRANSLATOR/LEGAL TODO
//
// This file currently mirrors the EN source document at `./en.tsx` verbatim.
// A Belgian Dutch cookie policy needs translation by legal counsel — every
...
export default function CookiesNlBeContent() {
  return (
    <>
      <section className="border-b border-[var(--color-border)] bg-[var(--color-bg-alt)]">
        <div className="mx-auto max-w-[var(--container)] px-6 py-16 md:py-20">
          ...
          {/* TODO(translator): "Cookie policy" title */}
          <h1
          ...
          {/* TODO(translator): translate "Last updated: 18 April 2026. How and why we use cookies and similar technologies." */}
        ...
        <div className="mx-auto grid max-w-[var(--container)] gap-12 px-6 lg:grid-cols-[220px_1fr]">
          ...
          <article className="max-w-prose">
            ...
            <div className="mt-16 rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-bg-alt)] p-6 text-sm text-[var(--color-ink-soft)]">
              {/* TODO(translator): translate "See also our" + "and" + leave links labelled "Privacy Policy" / "Terms of Service" translated too */}
              See also our{" "}
