  ...
  return (
    <div className={cn("flex items-start gap-3", className)}>
      <input
        ...
        className="mt-0.5 h-4 w-4 shrink-0 border border-[var(--color-border-strong)] bg-[var(--color-bg)] accent-[var(--color-brand)] cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent)] focus-visible:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed"
        {...props}
      />
