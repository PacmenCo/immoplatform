#!/usr/bin/env python3
"""Translate dashboard.assignments.newPage.* to nl-BE. Idempotent."""
import json
...
PATCHES: dict[str, str] = {
    "assignments.newPage.title": "Nieuwe opdracht",
    "assignments.newPage.subtitle": "Maak een nieuwe pandinspectie aan",
}
