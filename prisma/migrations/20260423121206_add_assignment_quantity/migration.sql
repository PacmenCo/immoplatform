...
INSERT INTO "new_assignments" ("address", "areaM2", "calendarAccountEmail", "calendarDate", "cancellationReason", "cancelledAt", "city", "clientType", "completedAt", "constructionYear", "contactEmail", "contactPhone", "createdAt", "createdById", "deliveredAt", "discountReason", "discountType", "discountValue", "freelancerId", "googleCalendarEventId", "id", "isLargeProperty", "keyPickup", "notes", "outlookCalendarAccountId", "outlookCalendarEventId", "ownerAddress", "ownerCity", "ownerEmail", "ownerName", "ownerPhone", "ownerPostal", "ownerVatNumber", "photographerContactPerson", "postal", "preferredDate", "propertyType", "reference", "status", "teamId", "tenantEmail", "tenantName", "tenantPhone", "updatedAt") SELECT "address", "areaM2", "calendarAccountEmail", "calendarDate", "cancellationReason", "cancelledAt", "city", "clientType", "completedAt", "constructionYear", "contactEmail", "contactPhone", "createdAt", "createdById", "deliveredAt", "discountReason", "discountType", "discountValue", "freelancerId", "googleCalendarEventId", "id", "isLargeProperty", "keyPickup", "notes", "outlookCalendarAccountId", "outlookCalendarEventId", "ownerAddress", "ownerCity", "ownerEmail", "ownerName", "ownerPhone", "ownerPostal", "ownerVatNumber", "photographerContactPerson", "postal", "preferredDate", "propertyType", "reference", "status", "teamId", "tenantEmail", "tenantName", "tenantPhone", "updatedAt" FROM "assignments";
